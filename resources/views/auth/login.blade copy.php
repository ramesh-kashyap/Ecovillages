                                ...
                                <div class="auth-form">
                                    ...
                                    <form action="{{ route('login') }}" method="POST">
                                        ...
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-primary btn-block"style="background-color:#49AF45;">Sign Me In</button>
                                        </div>
                                    </form>
                                    <div class="new-account mt-3">
                                        <p>Don't have an account? <a class="text-primary" href="{{ route('register') }}"style="color:#49AF45;">Sign up</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
