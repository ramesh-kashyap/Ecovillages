					...
					<div class="login-form">
						...
						<form action="{{ route('loginAction') }}" method="post">
							...
							<div class="mb-4">
								...
								<input type="text" name="username" class="form-control" placeholder="Enter sponsor username" value="{{ old('sponsor', request('reference')) }}" required>
							</div>
							...
							<div class="text-center mb-4">
								<button type="submit" class="btn btn-primary btn-block" style="background-color:rgb(73, 175, 69);">Sign In</button>
							</div>
						</form>
