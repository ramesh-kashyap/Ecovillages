...
<head>
    ...
    <title>ViserAsset - Referrals</title>
    <meta name="title" Content="ViserAsset - Referrals">
    ...
    <meta name="apple-mobile-web-app-title" content="ViserAsset - Referrals">

    <meta itemprop="name" content="ViserAsset - Referrals">
    <meta itemprop="description"
        content="AssetLab is a leading investment management company that specializes in managing various assets.">
    <meta itemprop="image"
        content="https://script.viserlab.com/viserasset/assets/images/seo/67d790a84bd001742180520.png">
    ...
    <meta property="og:url" content="https://script.viserlab.com/viserasset/user/referrals">
        ...
        <div class="dashboard__inner flex-wrap">
            ...
            <div class="sidebar-menu">
                ...
                <div class="sidebar-logo">
                    <a href="{{route('user.dashboard')}}" class="sidebar-logo__link"><img src="https://script.viserlab.com/viserasset/assets/images/logo_icon/logo.png" alt="" /></a>
                </div>
