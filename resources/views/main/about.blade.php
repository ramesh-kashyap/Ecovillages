			...
			<div class="col-lg-6 col-md-12">
				<div class="about-right">
				    ...
				    <div class="about-text">
				    	<span><img src="{{asset('')}}assets/images/shape.png" alt=""></span><a href="#">We’ve 10+ years of Experience Ecology</a>
				    </div>

				    <p class="about-desc">Credibly incentivize leveraged catalysts for change whereas premium scenarios. 
                    Professionally foster synergistic ROI for multidisciplinary</p>
                    ...
                    <div class="about-single-box">
		                ...
		                <div class="echofy-button">
							<a href="about.html">More About <img src="assets/images/button-shape.png" alt=""></a>
		...
		<div class="row align-items-center" id="poress-row">
			<div class="col-lg-6 col-md-12">
				<div class="porcess-thumb">
					<img src="{{asset('')}}assets/images/home1/process-thumb.jpg" alt="">
				</div>
			</div>
			<div class="col-lg-6 col-md-12">
				<div class="process-left">
					<div class="section-title left">
						...
						<p class="section-desc">
							Promotes cleaner air, conserves biodiversity, and helps combat climate change. Planting trees creates a healthier, greener, and more sustainable environment for future generations.
						</p>
					</div>
					<div class="echofy-button">
						<a href="contact.html">Contact Us <img src="{{asset('')}}assets/images/button-shape.png" alt=""></a>
						<img class="two" src="{{asset('')}}assets/images/button-shape-2.png" alt="">
					</div>
