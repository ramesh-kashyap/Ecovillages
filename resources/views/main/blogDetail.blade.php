...
<section class="flat-blog-detail">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="themesflat-spacer clearfix" data-desktop="166" data-mobile="0" data-smobile="0" style="height:166px"></div>
            </div>
            <div class="col-md-8">
                <div class="post-wrap">
                    <div class="content-blog-detail">
                        <div class="image-box">
                            <div class="image">
                                <img src="{{ asset('') }}images/profolio/home1-item2.jpg" alt="image">
                            </div>
                        </div>
                                ...
                                <div class="widgets-comment-box">
                                    <div class="box-1">
                                        <div class="image-comment bd-radius-50-image">
                                            <img src="{{ asset('') }}images/team/staff-box2.jpg" style="width: 60px; height:60px;" alt="image">
                                        </div>
                                    ...
                                    <div class="box-2">
                                        <div class="image-comment bd-radius-50-image">
                                            <img src="{{ asset('') }}images/team/staff-box1.jpg"style="width: 60px; height:60px;" alt="image">
                                        </div>
                                        <div class="content-comment">
                                            <div class="title">
                ...
                <div class="side-bar">
                        ...
                        <ul class="lastest-posts data-effect clearfix">
                            <li class="clearfix">
                                <div class="thumb data-effect-item has-effect-icon">
                                    <img src="{{ asset('') }}images/profolio/home1-item1.jpg" alt="Image">
                                    <div class="elm-link">
                            ...
                            <li class="clearfix">
                                <div class="thumb data-effect-item has-effect-icon">
                                    <img src="{{ asset('') }}images/profolio/home1-item3.jpg" alt="Image">
                                    <div class="elm-link">
                                        <a href="page-blog-single.html" class="icon-2"></a>
                                    </div>
                                </div>
                    ...
                    <div class="widgets-contact-info">
                        <div class="contact-info-img">
                            <img src="{{ asset('') }}images/profolio/home1-item4.jpg" alt="image">
                        </div>
            ...
            <!-- /.col-md-4 -->
            <div class="col-md-12">
                <div class="themesflat-spacer clearfix" data-desktop="193" data-mobile="60" data-smobile="60" style="height:193px"></div>
            </div>
        </div>
        <!-- /.row -->
    </div>
