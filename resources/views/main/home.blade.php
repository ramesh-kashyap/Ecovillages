			...
			<div class="row align-items-center">
				<div class="col-lg-12">
					<div class="hero-content">
						...
						<p class="hero-desc" data-animation="fadeInUp" data-delay="800ms" data-duration="1000ms">Empower intelligent systems through interoperable design and interdependent, scalable best practices.</p>
					</div>
	...
	<div class="inner-container">
		<div class="marquee">
			...
			<div class="marquee-block">
				...
				<!-- content-box -->
				<div class="content-box">
					<h6 class="title"><span><img src="assets/images/home1/text-shape.png" alt="">Regenerative</span></h6>
				</div>
				<!-- content-box -->
				<div class="content-box">
		...
		<div class="row align-items-center">
			<div class="col-lg-6">
				<div class="about-thumb">
					<img src="assets/images/home1/accordion-img-1.png" alt="">
					<img class="about-thumb-shape" src="assets/images/home1/about-award.png" alt="">
				</div>
			</div>
			<div class="col-lg-6">
				<div class="about-right">
					<div class="section-title left">
						<h4><img src="assets/images/home1/section-shape.png" alt="">About Ecovillages</h4>
		...
		<div class="row">
			<div class="col-lg-9">
				<div class="section-title left">
					...
					<h1>Comprehensive Solutions for Every </h1>
					<h1>Farming Need</h1>
				</div>
			</div>
			...
			<div class="service-list-1 owl-carousel">
				...
				<div class="col-lg-12">
					<div class="single-service-box">
						<div class="service-content">
							...
							<h4>Agri Clinics</h4>
							<p>The service provider will help in the Organic Farming and providing day to day Agri Clinics to the farmers.</p>
						</div>
						<div class="service-thumb">
							<img src="assets/images/home1/service-img-12.png" alt="">
						</div>
						<div class="service-box-shape">
							<img src="assets/images/home1/service-box-shape.png" alt="">
						</div>
				...
				<div class="col-lg-12">
					<div class="single-service-box">
						...
						<div class="service-thumb">
							<img src="assets/images/home1/service-img-14.png" height="265px">
						</div>
						<div class="service-box-shape">
							<img src="assets/images/home1/service-box-shape.png" alt="">
						</div>
			...
			<div class="col-lg-6 col-md-12">
				<div class="process-left">
					<div class="section-title left">
						...
						<p class="section-desc">Boosts local employment and increases revenue through enhanced business opportunities and infrastructure development.</p>

						</p>
					</div>
					<div class="echofy-button">
						<a href="{{route('contact-us')}}">Contact Us <img src="assets/images/home1/button-shape.png" alt=""></a>
						<img class="two" src="assets/images/home1/button-shape-2.png" alt="">
					</div>
				...
				<div class="col-lg-12">
					<div class="single-project-box">
						<div class="project-thumb">
							<img src="assets/images/home1/about-us-img-1.png" alt="">
						</div>
...
<!-- <div class="blog-area">
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-4">
				<div class="echofy-button">
					<a href="#">View All Blog <img src="assets/images/home1/button-shape.png" alt=""></a>
					<img class="two" src="assets/images/home1/button-shape-2.png" alt="">
				</div>
			</div>
		</div>
